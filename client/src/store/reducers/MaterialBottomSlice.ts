...
export const fetchMaterialsBottom = createAsyncThunk<
  IOption[],
  undefined,
  { rejectValue: string }
>('garantee/fetchMaterialsBottom', async function (_, { rejectWithValue }) {
  try {
...
export const createMaterialBottom = createAsyncThunk<
  IOption,
  string,
  { rejectValue: string }
>('garantee/createMaterialBottom', async function (name, { rejectWithValue }) {
  try {
